...
class CatalogAPI(object):
    ...
    def UpdateActuation(self, greenhouseID, areaID, motionDetected):
        #try:
        ...
        catalog["greenhouses"][greenhouseID-1]["areas"][areaID-1]["light"] = motionDetected
        ...
        print(f"light actuation updated to {motionDetected} in greenhouse {greenhouseID}, area {areaID}")
        return {
